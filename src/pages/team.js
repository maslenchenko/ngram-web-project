  ...
  return (
    <div class='team-main'>
      ...
      <div className='mentor'>
        <TeamMember name={mentorName}  description={mentorDescription} email={mentorEmail} student={false}/>
      </div>
      <div className='students'>
        <TeamMember name={studentName1} description={studentDescription1} email={studentEmail1}/>
        <TeamMember name={studentName2} description={studentDescription2} email={studentEmail2}/>
        <TeamMember name={studentName3} description={studentDescription3} email={studentEmail3}/>
        <TeamMember name={studentName4} description={studentDescription4} email={studentEmail4}/>
      </div>
    </div>  
  )
}
